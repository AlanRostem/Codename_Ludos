...
public class TestGame extends ArcadeGame {
    ...
    public void setup() {
        ...
        controls.createController("jump", new Button( 80, 150, 20, 20) {
        ...
        controls.createController("left", new Button( 10 , 150, 10, 10) {
            private int color = Color.GREEN;
        ...
        controls.createController("right", new Button(25, 150, 10, 10) {
            private int color = Color.GREEN;
